package com.example.notesapp.feature.share_preview
...
import com.example.notesapp.feature.share_preview.components.SharePreviewAppBar
...
fun SharePreviewPage(
    ...
    val date = DateUtils.convertDateString(
